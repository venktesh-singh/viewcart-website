                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="brdcrm breadcrumb">
                                    <li className="breadcrumb-item">
                                        <a href="#"><Image src="/images/home-icon.png" width={20} height={30} priority alt="" /> Home</a>
                                    </li>
                                                ...
                                                <div className="table_row">
                                                    <div className="table_small">
                                                        ...
                                                        <div className="table_cell table_cell_1">
                                                            <span className="pro_image"><Image src="/images/printer-image.png" width={20} height={30} priority alt="" /> </span>
                                                            <h1>
                                                                <a href="#">
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-3 col-md-3 col-6">
                        <div className="what_we_do">
                            <Image src="/images/delivery-icon.jpg"  width={20} height={30} priority alt="" />
                            <h2>Free Delivery</h2>
                    ...
                    <div className="col-lg-3 col-sm-3 col-md-3 col-6">
                        <div className="what_we_do">
                            <Image src="/images/return-icon.jpg"  width={20} height={30} priority alt="" />
                            <h2>Easy Returns</h2>
                    ...
                    <div className="col-lg-3 col-sm-3 col-md-3 col-6">
                        <div className="what_we_do">
                            <Image src="/images/quality-icon.jpg"  width={20} height={30} priority alt="" />
                            <h2>High Quality</h2>
                    ...
                    <div className="col-lg-3 col-sm-3 col-md-3 col-6">
                        <div className="what_we_do">
                            <Image src="/images/guarantee-icon.jpg"  width={20} height={30} priority alt="" />
