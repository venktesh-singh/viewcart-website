...
export default function Header() {
    return <>
        ...
        <div className="overlay sideheader" id="overlay">
            <a className="close_menu closesidebar" href="#"><Image src="images/remove.png" alt="" /> </a>
