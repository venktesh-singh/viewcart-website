                ...
                <div className="row">
                    ...
                    <div className="breadcrumb-heading">
                        ...
                        <ol className="brdcrm breadcrumb">
                            ...
                            <a href="#"><Image src="/images/home-icon.png" alt="Home" /> Home</a>
                            </li>
            ...
            <section className="categories_section bg_ofwhite pt-50">
                ...
                <div className="row">
                    ...
                    <div className="product_gallery">
                        ...
                        <div className="main-img-slider">
                            <a data-fancybox="gallery" href="images/product-main.jpg">
                                <Image src="/images/product-main.jpg" alt="Product Main"  />
                            </a>
                            <a data-fancybox="gallery" href="images/iphone-video.jpg">
                                <Image src="/images/iphone-video.jpg" alt="iPhone Video"  />
                            </a>
                            <a data-fancybox="gallery" href="images/iphone-1.jpg">
                                <Image src="/images/iphone-1.jpg" alt="iPhone 1"  />
                            </a>
                            <a data-fancybox="gallery" href="images/iphone-2.jpg">
                                <Image src="/images/iphone-2.jpg" alt="iPhone 2"  />
                            </a>
                            <a data-fancybox="gallery" href="images/iphone-3.jpg">
                                <Image src="/images/iphone-3.jpg" alt="iPhone 3"  />
                            </a>
                        </div>
                        <ul className="thumb-nav">
                            <li><Image src="/images/product-main.jpg" alt="Product Main" /></li>
                            <li><Image src="/images/iphone-video.jpg" alt="iPhone Video" /></li>
                            <li><Image src="/images/iphone-1.jpg" alt="iPhone 1" /></li>
                            <li><Image src="/images/iphone-2.jpg" alt="iPhone 2" /></li>
                            <li><Image src="/images/iphone-3.jpg" alt="iPhone 3" /></li>
                            <li><Image src="/images/product-main.jpg" alt="Product Main" /></li>
                            <li><Image src="/images/iphone-video.jpg" alt="iPhone Video" /></li>
                            <li><Image src="/images/iphone-1.jpg" alt="iPhone 1" /></li>
                            <li><Image src="/images/iphone-2.jpg" alt="iPhone 2" /></li>
                        ...
                        <div className="theme-button">
                            <Link href="/cart" className="default-btn"><Image src="images/add-item-image.png" alt="cart"  /> Add To Cart </Link>
                        </div>
                        <div className="theme-button1">
                            <Link href="/cart" className="default-btn"><Image src="images/buy-now-image.png" alt="buy"  /> Buy Now</Link>
                        </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="mainProduct">
                        ...
                        <div className="warrantyBox">
                            ...
                            <Image src="images/apple-icon.png" alt="apple" />
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="colorBox">
                                ...
                                <a href="#"> <Image src="images/iphone-gray.jpg" alt="iphone"  /></a>
                                </div>
                                <div className="color_aval">
                                <a href="#"><Image src="images/iphone-gold.jpg"  alt="" /></a>
                                </div>
                                <div className="color_aval">
                                <a href="#"> <Image src="images/iphone-gray.jpg" alt="" /></a>
                                </div>
                                <div className="color_aval">
                                <a href="#"> <Image src="images/iphone-gray.jpg" alt="" /></a>
                                </div>
                        ...
                        <div className="deliveryInfo">
                            <span><Image src="images/delivery-image.png" alt="" /> Deliver to</span>
                ...
                <div className="row align-items-center protect_product">
                    ...
                    <div className="protect_box">
                        <div className="check"><Image src="images/check-image.png" alt=""  /></div>
                        <div className="apple_care">
                        <Image src="images/apple-care.png" alt=""  />
                        </div>
                    ...
                    <div className="protect_box">
                        <div className="check"><Image src="images/check-image.png" alt=""  /></div>
                        <div className="apple_care">
                        <Image src="images/warranty-image.png" alt="" />
                        </div>
                        <div className="apple_care_content">
            ...
            <section className="categories_section bg_ofwhite">
                ...
                <div className="row">
                    ...
                    <div className="item_list">
                        ...
                        <div className="itemsBox">
                        <div className="theme-button">
                            <a href="#" className="default-btn"><Image src="images/add-item-image.png" alt=""  /> Add 3 items to cart</a>
                        </div>
                        </div>
                    </div>
            ...
            <section className="review_rating_section bg_ofwhite">
                ...
                <div className="row">
                    ...
                    <div className="well well-sm">
                        ...
                        <a href="#"><Image src="images/review-image.jpg"  alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-1.jpg" alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-2.jpg" alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-3.jpg" alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-4.jpg" alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-5.jpg" alt=""  /> </a>
                        <a href="#"><Image src="images/review-image-6.jpg" alt=""  /> </a>
                        <a className="overlay1" href="#">
                            <Image alt="" src="images/review-image-7.jpg"  />
                            <span> +49</span>
                        </a>
                        </div>
                    </div>
            ...
            <section className="all_rating_section bg_ofwhite">
                ...
                <div className="row">
                    ...
                    <div className="safe_seq">
                        <p><Image src="images/safe-icon.png" alt="" /> Safe and Secure Payments.Easy returns.100% Authentic products.</p>
                    </div>
                    </div>
                </div>
                </div>
