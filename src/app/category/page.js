                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="brdcrm breadcrumb">
                                    <li className="breadcrumb-item">
                                        <a href="#"><Image src="images/home-icon.png" alt="" /> Home</a>
                                    </li>
                                                    ...
                                                    <div className="card-body">
                                                        <div className="color_box">
                                                            <div className="search_box">
                                                                ...
                                                                <button><Image src="images/search-black.png" alt="" /></button>
                                                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-4 col-sm-4 col-12">
                                <div className="product_item">
                                    ...
                                    <div className="product_image">
                                        <Link href="/detail"> <Image src="images/iphone.jpg" alt="" /></Link>
                                    </div>
                                    <div className="pro_info">
                                        ...
                                        <div className="add_cart">
                                            <Link href="/detail"><Image src="images/cart-icon.png" alt="" /> Add to Cart</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-4 col-12">
                                <div className="product_item">
                                    ...
                                    <div className="product_image">
                                        <a href="#"> <Image src="images/iphone.jpg" alt="" /></a>
                                    </div>
                                    <div className="pro_info">
                                        <h1>brother</h1>
                            ...
                            <div className="col-lg-12 col-md-4 col-sm-4 col-12">
                                <div className="pagination">
                                    <ul>
                                        <li>
                                            <a href="#"><Image src="images/page-arrow.png" alt="" /> Prev</a>
                                        </li>
                                        <li><a className="active" href="#">1</a></li>
                                        <li><a href="#">2</a></li>
                                        <li><a href="#">3</a></li>
                                        <li>
                                            <a href="#">Next <Image src="images/page-arrow-next.png" alt="" /> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
